...
_Designer gửi mockup Portfolio v1 hoàn chỉnh. Bạn cần chuyển từ pure HTML/CSS sang Bootstrap 5 mà vẫn giữ nguyên design và responsive behavior._
...
```html
<section
  class="min-vh-100 d-flex align-items-center justify-content-center text-center text-white"
